...
class DataUserController extends Controller
{
    ...
    public function save_us(Request $Request)
 	{
 		...
 		return redirect()->route('index_us')->with('add', 'Data Saved Successfully!');
	 }
	...
	public function save_edit_us(Request $Request){ 
	  ...
	  return redirect()->route('index_us')->with('update', 'Data Updated Successfully!');
	}
    ...
    public function delete_us($id)
	{
		...
		return redirect()->route('index_us')->with('delete', 'Data Deleted Successfully!');
   }
}
