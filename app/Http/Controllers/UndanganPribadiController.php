...
class UndanganPribadiController extends Controller
{
    ...
    public function simpan(Request $Request)
 	{
 		...
 		return redirect()->route('index_up')->with('add', 'Data Saved Successfully!');
	 }
	...
	public function save(Request $request){ 
	  ...
	  return redirect()->route('index_up')->with('update', 'Data Updated Successfully!');
	}
	...
	public function delete($id)
	{
		...
		return redirect()->route('index_up')->with('delete', 'Data Deleted Successfully!');
   }
}
