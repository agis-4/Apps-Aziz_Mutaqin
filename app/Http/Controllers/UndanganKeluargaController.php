...
class UndanganKeluargaController extends Controller
{
    ...
    public function simpan_uk(Request $Request)
 	{
 		...
 		return redirect()->route('index_uk')->with('add', 'Data Saved Successfully!');
	 }
	...
	public function save_uk(Request $request){ 
	  ...
	  return redirect()->route('index_uk')->with('update', 'Data Updated Successfully!');
	}
	...
	public function delete_uk($id)
	{
		...
		return redirect()->route('index_uk')->with('delete', 'Data Deleted Successfully!');
   }
   public function new()
    {        
    	return view('new');
